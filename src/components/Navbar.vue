<template>
    <section>
            ...
            <v-list class="OpenSans fs13">
                ...
                <div>
                    <div>
                        ...
                        <v-list-group value="Group" color="#FFFFFF">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <v-list-item to="/" >
                                        <v-list-item-content class="p-icon-nav" style="margin-right:14px">Sales Order</v-list-item-content>
                                    </v-list-item>
                                    <!-- <hr class="mx-4 hr-navbar"> -->
        ...
        <v-app-bar app color="white" flat class="OpenSans fs14" dense>
            ...
            <v-toolbar-title class="nav-title">Sales Order</v-toolbar-title>
